...
(function() {
  ...
  (function($) {
    var $add_course_button, $class_type_button, $department_list, attach_delete_button_events, class_filter, class_type, filtered_courses, flash_message, have_class, reset_add_modal, student_id;
